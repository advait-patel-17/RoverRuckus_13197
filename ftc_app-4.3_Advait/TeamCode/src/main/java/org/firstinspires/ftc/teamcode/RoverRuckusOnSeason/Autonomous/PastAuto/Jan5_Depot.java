...
@Autonomous
@Disabled
public class Jan5_Depot extends LinearOpMode{
...
*/
        ...
        moveWithEncoders(0.3, 600);

        IMUTurn(37.5, 0.3, -0.3, 1);
        sleep(500);
        ...
        moveWithEncoders(-0.3, 300);

        //moveWithEncoders(0.3, 350);
        //telemetry.addData("Status", "Done Strafing, about to do Vuforia.");
        //telemetry.update();
        sleep(1000);

        //strafeAngle(-0.5, Math.PI/6, 500);
        //sleep(500);
...
*/
            ...
            default:
                telemetry.addData("Position", "None Detected. Defaulting Left.");
                telemetry.update();
