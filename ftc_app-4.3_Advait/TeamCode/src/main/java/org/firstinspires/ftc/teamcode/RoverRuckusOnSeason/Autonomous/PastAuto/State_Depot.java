...
import org.firstinspires.ftc.teamcode.RoverRuckusOnSeason.Robot.Robot;
import org.firstinspires.ftc.teamcode.RoverRuckusOnSeason.Robot.VisionV2;

@Autonomous
@Disabled
public class State_Depot extends LinearOpMode{
...
//        sleep(100);
        ...
        robot.intakeFlip2.setPosition(0.45);
        sleep(100);
...
*/
        ...
        robot.strafe(0.5, 800, this);
        robot.moveWithEncoders(0.65, 600, this);
        robot.intakeFlip1.setPosition(0.55);
        robot.intakeFlip2.setPosition(0.55);
        sleep(2000);
    }
